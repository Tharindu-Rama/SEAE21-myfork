import sensors_main
import unittest
from unittest.mock import patch # needed for the example intregation test case to work.
import sys # needed for setting the comand line parameters for test cases
